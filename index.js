...
app.use("/add-new-motor", (req, res) => {
    res.send(
        `
        <div style="margin-top:100px; display:flex; flex-direction:column; align-items:center">
            <h1 style="text-align:center">ADD new 'Motor'</h1>
            <form action="/motor" method="POST" style="background-color: #f2f2f2; display: flex; flex-direction: column; gap: 20px; width: 400px; padding: 20px; ">
